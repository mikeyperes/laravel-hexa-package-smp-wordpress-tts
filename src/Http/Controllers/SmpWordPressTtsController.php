...
class SmpWordPressTtsController extends Controller
{
    public function __construct(
        ...
        protected SmpWordPressTtsApiService $api
    ) {
    }
    ...
    public function dashboard(): View
    {
        return view("smp-wordpress-tts::dashboard.index", [
            ...
            "requestPollUrl" => route("smp-wordpress-tts.requests"),
            "apiProviders" => $this->api->providerRuntimeSnapshot(),
        ]);
    }
    ...
    public function settings(): View
    {
        return view("smp-wordpress-tts::settings.index", [
            ...
            "apiProviders" => $this->api->providerRuntimeSnapshot(),
            "unrealKeys" => $this->api->listProviderKeys("unrealspeech"),
        ]);
    }
    ...
    {
        $validated = $request->validate(["server_id" => ["required", "integer", "min:1"]]);
        return response()->json(["success" => true, "accounts" => $this->tts->accountsForServer((int) $validated["server_id"])]);
    }
